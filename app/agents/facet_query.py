...
def generate_filter_question(solr_query: str, filter_options) -> str:
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": f"Query from user: {solr_query}\n Facets: {json.dumps(filter_options, indent=4)}"},
        ],
    )
